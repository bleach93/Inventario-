 ...
 * @author Eduardo
 */
public class DetalleRecibos extends javax.swing.JDialog {
    
    DefaultTableModel miModelo;
    /**
     * Creates new form DetalleRecibos
     */
    public DetalleRecibos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void mostrarDetalleRecibos(int idrecibo) {
        ...
        miModelo =  (DefaultTableModel) tblRecibos.getModel();
        DDRecibos dts = new DDRecibos();
        LDRecibos fun = new LDRecibos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetalleRecibos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DetalleRecibos dialog = new DetalleRecibos(new javax.swing.JFrame(), true);
